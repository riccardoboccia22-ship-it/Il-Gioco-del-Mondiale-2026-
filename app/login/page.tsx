          ...
          <div className="space-y-6">
            ...
            <div className="bg-yellow-500 p-6 rounded-[2rem] flex items-center justify-between shadow-lg shadow-yellow-500/20">
              <div>
                ...
                <p className="text-5xl font-black text-slate-950 tracking-tighter">{stats.total}</p>
              </div>
              <div className="text-right">
                <p className="text-[9px] font-black text-slate-950/60 uppercase tracking-widest italic">Ranking</p>
                <p className="text-2xl font-black text-slate-950">#{stats.rank}</p>
              </div>
            </div>

            {/* GRIGLIA DETTAGLIO PUNTI */}
            <div className="space-y-3">
              <h2 className="text-[10px] font-black text-slate-500 uppercase tracking-[0.3em] ml-2 italic">Dettaglio Punteggi</h2>
              <div className="grid grid-cols-3 gap-3">
                <div className="bg-slate-900/50 border border-slate-800 p-4 rounded-3xl text-center">
                  <p className="text-[8px] font-black text-slate-500 uppercase italic mb-1 tracking-widest leading-none">Gironi</p>
                  <p className="text-xl font-black text-white">{stats.groups}</p>
                </div>
                <div className="bg-slate-900/50 border border-slate-800 p-4 rounded-3xl text-center">
                  <p className="text-[8px] font-black text-slate-500 uppercase italic mb-1 tracking-widest leading-none">Fase Finale</p>
                  <p className="text-xl font-black text-white">{stats.bracket}</p>
                </div>
                <div className="bg-slate-900/50 border border-slate-800 p-4 rounded-3xl text-center">
                  <p className="text-[8px] font-black text-slate-500 uppercase italic mb-1 tracking-widest leading-none">Bonus</p>
