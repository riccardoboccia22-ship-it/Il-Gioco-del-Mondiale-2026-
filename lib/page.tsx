  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white p-6 pb-32">
      <header className="text-center mb-10 mt-6">
        <h1 className="text-4xl font-black text-yellow-500 uppercase italic italic">Super Bonus</h1>
        <p className="text-slate-400 text-xs mt-2 uppercase tracking-widest font-bold">Guadagna 30 punti extra</p>
      </header>
      ...
      <form onSubmit={saveBonus} className="max-w-md mx-auto space-y-6">
        <div className="bg-slate-900 p-6 rounded-[2rem] border border-slate-800 space-y-4 shadow-xl">
          <label className="block">
            <span className="text-[10px] font-black text-yellow-500 uppercase mb-2 block">🔴 Totale Espulsioni (10pt)</span>
            <input 
              type="number" 
              placeholder="Esempio: 12"
          ...
          <label className="block">
            <span className="text-[10px] font-black text-yellow-500 uppercase mb-2 block">👟 Capocannoniere (10pt)</span>
            <input 
              type="text" 
          ...
          <label className="block">
            <span className="text-[10px] font-black text-yellow-500 uppercase mb-2 block">🔥 Partita con più gol (10pt)</span>
            <input 
              type="text" 
              placeholder="Esempio: Italia-Brasile"
              className="w-full bg-slate-800 border-2 border-slate-700 rounded-2xl p-4 outline-none focus:border-yellow-500 transition-all font-bold"
